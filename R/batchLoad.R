#' @title Load the Models Generated by \code{\link{regressoR.batchLearn}} as \code{\link[dataManageR]{dataset}}s
...
#' @return a list of \code{\link[dataManageR]{dataset}} instances whose \code{data} elements correspond to models
